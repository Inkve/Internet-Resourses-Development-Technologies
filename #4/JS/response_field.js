...
function test_start(){
    ...
    qwerty.generate_checkbox_question('Какой вид противопожарного инструктажа проходят работники при устройстве на работу?', ["Целевой", "Выдуманный", "Плановый", "!Первичный"], "!Первичный");
    ...
    qwerty.generate_selection_question('К вторичным проявлениям опасных факторов пожара, которые оказывают воздействие на материальные ценности и людей, относятся:', ["!Вещества, предназначенные для огнетушения", "Ответ5_2", "Ответ5_3", "Ответ5_4"], "!Вещества, предназначенные для огнетушения");
