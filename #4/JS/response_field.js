...
function test_start(){
    ...
    qwerty.generate_selection_question('ЧТО1', ["Ответ1_1", "Ответ1_2", "Ответ1_3", "Ответ1_4"], "Надо1");
    qwerty.generate_checkbox_question('ЧТО2', ["Ответ2_1", "Ответ2_2", "Ответ2_3", "Ответ2_4"], "Надо2");
    qwerty.generate_radiobutton_question('ЧТО3', ["Ответ3_1", "Ответ3_2", "Ответ3_3", "Ответ3_4"], "Надо3");
    qwerty.generate_free_answer_question('ЧТО4', ["Ответ4_1", "Ответ4_2", "Ответ4_3", "Ответ4_4"], "Надо4");
    qwerty.generate_selection_question('ЧТО5', ["Ответ5_1", "Ответ5_2", "Ответ5_3", "Ответ5_4"], "Надо5");
    qwerty.generate_checkbox_question('ЧТО6', ["Ответ6_1", "Ответ6_2", "Ответ6_3", "Ответ6_4"], "Надо6");
    qwerty.generate_radiobutton_question('ЧТО7', ["Ответ7_1", "Ответ7_2", "Ответ7_3", "Ответ7_4"], "Надо7");
    qwerty.generate_free_answer_question('ЧТО8', ["Ответ8_1", "Ответ8_2", "Ответ8_3", "Ответ8_4"], "Надо8");
